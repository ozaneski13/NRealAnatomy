...
namespace NRKernal
{
    public class SelectAnatomyTimer : MonoBehaviour
    {
        ...
        [SerializeField] private AnatomyPanel anatomyPanel = null;
        ...
        private IEnumerator TimerRoutine()
        {
            ...
            while (true)
            {
                ...
                {
                    anatomyPanel.AutoToggle(secondTg);
